# Gensol Engineering - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/gensol-engineering-audit-report.pdf` (Lead score 2/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): Gensol Engineering - No ROI / payback calculator gated behind form on site

Hi,

I spent 30 minutes on your Meta ad library and gensol.in. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to Gensol Engineering: No ROI / payback calculator gated behind form on site

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi Gensol Engineering team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: Gensol Engineering (gensol.in), Ahmedabad - verified in Meta Ad Library India.
