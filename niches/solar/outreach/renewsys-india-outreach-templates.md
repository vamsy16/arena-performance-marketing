# RenewSys India - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/renewsys-india-audit-report.pdf` (Lead score 4/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): RenewSys India - No case-study PDF or site-survey scheduler for facility heads

Hi,

I spent 30 minutes on your Meta ad library and renewsys.com. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to RenewSys India: No case-study PDF or site-survey scheduler for facility heads

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi RenewSys India team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: RenewSys India (renewsys.com), Bengaluru - verified in Meta Ad Library India.
