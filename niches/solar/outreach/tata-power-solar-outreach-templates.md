# Tata Power Solar - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/tata-power-solar-audit-report.pdf` (Lead score 6/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): Tata Power Solar - No ROI / payback calculator gated behind form on site

Hi,

I spent 30 minutes on your Meta ad library and tatapowersolar.com. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to Tata Power Solar: No ROI / payback calculator gated behind form on site

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi Tata Power Solar team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: Tata Power Solar (tatapowersolar.com), Bengaluru - verified in Meta Ad Library India.
