# Mahindra Susten - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/mahindra-susten-audit-report.pdf` (Lead score 3/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): Mahindra Susten - No case-study PDF or site-survey scheduler for facility heads

Hi,

I spent 30 minutes on your Meta ad library and mahindrasusten.com. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to Mahindra Susten: No case-study PDF or site-survey scheduler for facility heads

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi Mahindra Susten team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: Mahindra Susten (mahindrasusten.com), Mumbai - verified in Meta Ad Library India.
