# SolarSquare - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/solarsquare-audit-report.pdf` (Lead score 4/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): SolarSquare - Landing page loads 4s+ on mobile 4G

Hi,

I spent 30 minutes on your Meta ad library and solarsquare.in. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to SolarSquare: Landing page loads 4s+ on mobile 4G

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi SolarSquare team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: SolarSquare (solarsquare.in), Mumbai - verified in Meta Ad Library India.
