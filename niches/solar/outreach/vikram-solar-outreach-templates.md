# Vikram Solar - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/vikram-solar-audit-report.pdf` (Lead score 4/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): Vikram Solar - No LinkedIn ABM layer while running broad Meta

Hi,

I spent 30 minutes on your Meta ad library and vikramsolar.com. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to Vikram Solar: No LinkedIn ABM layer while running broad Meta

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi Vikram Solar team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: Vikram Solar (vikramsolar.com), Kolkata - verified in Meta Ad Library India.
