# UTL Solar - Outreach Templates (Smart Pursuit BD team)

> Companion to `audits/utl-solar-audit-report.pdf` (Lead score 4/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): UTL Solar - Amazon/Flipkart listings not linked from ads (trust gap)

Hi,

I spent 30 minutes on your Meta ad library and utlsolar.com. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to UTL Solar: Amazon/Flipkart listings not linked from ads (trust gap)

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi UTL Solar team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: UTL Solar (utlsolar.com), New Delhi - verified in Meta Ad Library India.
