...
> Companion to `audits/mysun-audit-report.pdf` (Lead score 4/10). Do NOT attach to the audit PDF - internal BD templates only.

---

### Subject A (Roast-Audit): MYSUN - Google reviews strong but not shown in creatives

Hi,

I spent 30 minutes on your Meta ad library and mysun.co. I found 3 leaks that are costing you enquiries:
...
P.S. One flag specific to MYSUN: Google reviews strong but not shown in creatives

---

### Subject B (WhatsApp / Loom - 30 sec)

"Hi MYSUN team - I recorded a 3-minute walkthrough of your ad -> landing page -> form flow showing where the site-survey requests are leaking. Want me to send the link on WhatsApp? You can watch it and decide, no call needed."
...
Ref: MYSUN (mysun.co), New Delhi - verified in Meta Ad Library India.
